...
custom_loss = OrdinalLoss(class2coords, 1, betas=[1,1.5]).cuda()
...
for i in range(epochs):
    tr_l, tr_f1, tr_qwk = trainer(train_loader, classifier2, custom_loss, adam)
    vl_l, vl_f1, vl_qwk = validator(val_loader, classifier2, custom_loss)
    ...
    if vl_f1 > best_f1 * 1.01:
        ...
        torch.save(classifier2.state_dict(), f'{path}/best_conv1d_cls_{i}.pth.tar')
    else:

...
custom_loss = OrdinalLoss(class2coords, 0.75, betas=[1,3]).cuda()
...
# %%
folder_name = 'final11_half_more_lum'
...
for i in range(epochs):
    tr_l, tr_f1, tr_qwk = trainer(train_loader, classifier, loss, adamw)
    vl_l, vl_f1, vl_qwk = validator(val_loader, classifier, loss)
